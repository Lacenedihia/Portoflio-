  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon  ">
          <ul>
            <li>
              <a
                href="https://www.linkedin.com/in/dihia-lacene"
      ...
      <div className="footer--content--container">
        <p className="footer--content"> {t("Made with ♡ by Dihia")}</p>
        <p className="footer--freepik"> {t("Incorporates resources from")} <a href="www.freepik.com">Freepik</a> </p>
